...
- [ultralytics/yolov5](https://github.com/ultralytics/yolov5) - Ultralytics YOLOv5 in PyTorch for object detection, instance segmentation, and image classification with training, validation, inference, PyTorch Hub, and multi-format export.
